...
export class Person extends GameObject {
    constructor(config) {
        ...
        this.isMoving = false;
        this.moveProgress = 0;
        this.moveSpeed = config.moveSpeed || 0.04; // Slower movement for NPCs
    ...
    draw(ctx, camera, ts) {
        ...
        // Round coordinates to prevent sub-pixel rendering jitter on mobile
        const screenX = Math.round(drawX - camera.x);
        const screenY = Math.round(drawY - camera.y);
